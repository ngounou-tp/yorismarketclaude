...
.hero h1{font-family:'Syne',sans-serif;font-size:clamp(1.7rem,3.2vw,2.8rem);font-weight:800;color:#fff;line-height:1.12;margin-bottom:14px;letter-spacing:-1.2px;}
...
.cta-w{background:rgba(255,255,255,.1);color:#fff;border:1px solid rgba(255,255,255,.2);padding:12px 22px;border-radius:10px;font-family:'DM Sans',sans-serif;font-weight:600;font-size:.82rem;cursor:pointer;backdrop-filter:blur(8px);transition:background var(--yorix-t-base),transform var(--yorix-t-base);}
.cta-w:hover{background:rgba(255,255,255,.18);transform:translateY(-1px);}
.hero-stats{display:flex;gap:28px;flex-wrap:wrap;}
.stat-item{display:flex;flex-direction:column;}
.stat-num{font-family:'Syne',sans-serif;font-size:1.5rem;font-weight:800;color:#b7e4c7;line-height:1;}
...
.hc-title{font-family:'Syne',sans-serif;font-size:.95rem;font-weight:700;color:#fff;margin-bottom:14px;}
...
.sf select,.sf input{border:none;padding:11px 12px;font-family:'DM Sans',sans-serif;font-size:.8rem;outline:none;background:transparent;color:#0d1f14;}
.sf select{background:#f0ece6;border-right:1px solid #e2ddd6;min-width:98px;}
.sbtn{width:100%;background:var(--yorix-green-gradient);color:#fff;border:none;padding:11px;border-radius:10px;font-family:'Syne',sans-serif;font-weight:700;font-size:.82rem;cursor:pointer;margin-bottom:10px;transition:filter var(--yorix-t-fast),transform var(--yorix-t-fast);box-shadow:0 4px 14px rgba(26,107,58,.35);}
...
.price{font-family:'Syne',sans-serif;font-size:1rem;font-weight:800;color:var(--green);letter-spacing:-.3px;}
...
.skeleton{display:block;background:linear-gradient(90deg,var(--skeleton-base,${dark?"#1c2e22":"#ede8df"}) 25%,var(--skeleton-highlight,${dark?"#253d2b":"#e2ddd6"}) 50%,var(--skeleton-base,${dark?"#1c2e22":"#ede8df"}) 75%);background-size:800px 100%;animation:yorix-shimmer 1.4s infinite linear;border-radius:var(--skeleton-line-radius,var(--yorix-r-md));}
.skeleton-grid{width:100%;}
.skeleton-card{background:var(--skeleton-surface,var(--surface));border:1px solid var(--skeleton-border,var(--border));border-radius:var(--skeleton-card-radius,14px);overflow:hidden;min-height:100%;}
.skeleton-card .prod-img-wrap{display:block;height:180px;background:var(--surface2);}
.skeleton-img{width:100%;height:100%;border-radius:0;}
.skeleton-card .prod-info{padding:12px;gap:7px;}
.skeleton-text{height:12px;border-radius:6px;}
.skeleton-text-sm{height:10px;border-radius:6px;width:58%;}
.skeleton-name{width:78%;}
.skeleton-category{width:56%;}
.skeleton-desc{width:88%;}
.skeleton-desc-short{width:68%;}
.skeleton-price{height:18px;border-radius:6px;width:44%;margin-top:4px;}
.skeleton-button{height:34px;width:100%;border-radius:var(--skeleton-button-radius,8px);margin-top:6px;}
.prod-card.skeleton-card{cursor:default;pointer-events:none;}
.prod-card.skeleton-card:hover{transform:none;box-shadow:none;border-color:var(--border);}
.fiche-skeleton{min-height:100vh;background:var(--bg);padding-bottom:40px;}
.fiche-skeleton-inner{max-width:1100px;margin:0 auto;padding:16px;}
.fiche-skeleton-back{width:92px;height:18px;margin:8px 0 22px;border-radius:8px;}
.fiche-skeleton-image{width:100%;height:300px;border-radius:12px;margin-bottom:12px;}
.fiche-skeleton-thumbs{display:flex;gap:8px;flex-wrap:wrap;padding-bottom:4px;}
.fiche-skeleton-thumb{width:70px;height:70px;border-radius:8px;flex-shrink:0;}
.fiche-skeleton-info{display:flex;flex-direction:column;gap:12px;}
.fiche-skeleton-strip{width:100%;max-width:360px;height:34px;border-radius:10px;}
.fiche-skeleton-title{width:78%;height:28px;border-radius:8px;}
.fiche-skeleton-line{width:100%;height:14px;border-radius:7px;}
.fiche-skeleton-line.short{width:68%;}
.fiche-skeleton-price{width:42%;height:34px;border-radius:9px;margin-top:4px;}
.fiche-skeleton-cta{width:100%;height:44px;border-radius:9px;margin-top:4px;}
.fiche-skeleton-ghost{width:100%;height:42px;border-radius:9px;}
...
.empty-state h3{font-family:'Syne',sans-serif;font-size:1.05rem;font-weight:700;color:var(--ink);margin-bottom:8px;}
...
.modal{background:var(--surface);border-radius:20px;padding:26px;width:100%;max-width:480px;position:relative;border:1px solid var(--border);max-height:92vh;overflow-y:auto;box-shadow:var(--yorix-sh-lg);animation:yorix-modal-in var(--yorix-t-base) var(--yorix-ease-out);}
...
.modal-title{font-family:'Syne',sans-serif;font-size:1.25rem;font-weight:800;color:var(--ink);margin-bottom:4px;letter-spacing:-.6px;}
...
.dash-name{font-family:'Syne',sans-serif;font-weight:800;font-size:.93rem;text-align:center;color:var(--ink);margin-bottom:4px;max-width:100%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;padding:0 4px;}
...
.dash-page-title{font-family:'Syne',sans-serif;font-weight:800;font-size:1.25rem;color:var(--ink);margin-bottom:18px;letter-spacing:-.6px;display:flex;align-items:center;gap:8px;}
...
.dstat-val{font-family:'Syne',sans-serif;font-size:1.4rem;font-weight:800;color:var(--ink);letter-spacing:-.5px;}
...
.notif-title{font-family:'Syne',sans-serif;font-size:15px;font-weight:700;line-height:1.35;color:var(--ink);margin:0;overflow:hidden;word-break:break-word;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;}
...
.msg-hub-new-btn{flex-shrink:0;padding:7px 12px;border-radius:50px;border:none;background:var(--green);color:#fff;font-family:'Syne',sans-serif;font-weight:800;font-size:.72rem;cursor:pointer;min-height:36px;touch-action:manipulation;transition:transform .12s ease,filter .15s;}
...
.msg-new-modal__title{margin:0;font-family:'Syne',sans-serif;font-weight:800;font-size:1rem;color:var(--ink);}
...
.msg-new-modal__av-fallback{font-family:'Syne',sans-serif;font-weight:800;font-size:1.1rem;color:var(--green);}
...
.msg-new-modal__error strong{display:block;margin-bottom:6px;font-family:'Syne',sans-serif;}
...
.yorix-toast__close{flex-shrink:0;width:28px;height:28px;border:none;border-radius:50%;background:rgba(255,255,255,.15);color:#fff;cursor:pointer;font-size:1rem;line-height:1;}
@keyframes yorixToastIn{from{opacity:0;transform:translateX(-50%) translateY(12px);}to{opacity:1;transform:translateX(-50%) translateY(0);}}
.msg-hub-title{font-family:'Syne',sans-serif;font-weight:800;font-size:1rem;color:var(--ink);margin:0;letter-spacing:-.3px;}
...
.msg-conv-av{width:44px;height:44px;border-radius:12px;background:var(--green-pale);color:var(--green);display:flex;align-items:center;justify-content:center;font-family:'Syne',sans-serif;font-weight:800;font-size:.95rem;flex-shrink:0;border:1px solid var(--border);}
.msg-conv-copy{flex:1;min-width:0;}
.msg-conv-name{font-family:'Syne',sans-serif;font-weight:800;font-size:.82rem;color:var(--ink);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}
...
.msg-hub-header-title{font-family:'Syne',sans-serif;font-weight:800;font-size:.92rem;}
...
.msg-system-title{display:block;font-family:'Syne',sans-serif;font-weight:800;font-size:.88rem;margin-bottom:6px;color:var(--ink);}
...
.msg-blocked-banner strong{display:block;font-family:'Syne',sans-serif;font-size:.88rem;margin-bottom:8px;color:#92400e;}
...
.admin-broadcast-input,.admin-broadcast-textarea{width:100%;margin-top:6px;border:1.5px solid var(--border);border-radius:10px;padding:10px 12px;font-family:'DM Sans',sans-serif;font-size:.85rem;}
...
.admin-broadcast-send{width:100%;padding:14px;background:linear-gradient(135deg,var(--green),#145a32);color:#fff;border:none;border-radius:12px;font-family:'Syne',sans-serif;font-weight:800;font-size:.9rem;cursor:pointer;}
...
.admin-broadcast-preview-title{font-family:'Syne',sans-serif;font-weight:800;font-size:.8rem;margin-bottom:12px;color:var(--gray);}
...
@media(max-width:768px){
  ...
  .msg-hub{max-width:100%;overflow:hidden;}
...
.nav-search>button:hover{filter:brightness(1.1)!important;}
...
.dstat-val{font-family:'Syne',sans-serif!important;font-size:1.4rem!important;font-weight:800!important;color:var(--ink)!important;letter-spacing:-.02em!important;}
...
.oc-name{font-family:'Syne',sans-serif!important;font-weight:700!important;font-size:.84rem!important;}
